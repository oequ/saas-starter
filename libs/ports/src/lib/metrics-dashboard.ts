import type { OutboundEmail } from './models/email.model';
import type {
  MetricsDashboard,
  MetricsFilters,
  MetricsTimeSeries,
...
export function buildMetricsDashboardFromEmails(
...
/** @deprecated Use `buildMetricsDashboardFromEmails` */
export const buildMockMetricsDashboard = buildMetricsDashboardFromEmails;
