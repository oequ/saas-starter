import type { CommercialPlanId } from './billing.utils';
import type {
  EmailListPeriod,
  OutboundEmail,
} from './models/email.model';
import type { MetricsFilters, MetricsPeriod } from './models/metrics.model';
import { emailPeriodCutoffIso } from './emails.utils';
...
/** Resend-aligned transactional email caps — keep in sync with `private.email_quota_for_plan` in Postgres. */
