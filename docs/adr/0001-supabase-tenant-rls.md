...
7. **Stripe (`0009`, optional):** Edge Functions + webhooks update plan/seats via `apply_stripe_subscription`. With `STRIPE_ENABLED=true`, Checkout/Portal replace mock upgrade/downgrade; CI/E2E stay mock. See [STRIPE_LOCAL.md](../STRIPE_LOCAL.md).
